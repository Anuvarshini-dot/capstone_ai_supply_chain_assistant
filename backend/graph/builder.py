...
Flow:
  START
    → input_guardrail_node
        → END                                         (invalid query — too short, PII, etc.)
        → general_check_node
...
def build_graph():
    ...
    # ── Register nodes ────────────────────────────────────────────
    g.add_node("input_guardrail_node", input_guardrail_node)
    ...
    # ── Entry point ───────────────────────────────────────────────
    g.add_edge(START, "input_guardrail_node")

    # ── guardrail → END (invalid) or general_check ───────────────
    g.add_conditional_edges(
        "input_guardrail_node",
        route_after_guardrail,
        {
            "end":               END,
            "general_check_node": "general_check_node",
        }
    )
